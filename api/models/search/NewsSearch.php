...
class NewsSearch extends News
{
    ...
    {
        return [
            [['id', 'file_id', 'created_at', 'updated_at', 'created_by', 'updated_by', 'category_id'], 'integer'],
            [['title', 'description', 'new_owner', 'new_date'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'title', $this->title])
            ...
            ->andFilterWhere(['like', 'new_owner', $this->new_owner])
